...
//!
//! This module handles:
//! - Battery voltage monitoring via ADC (reads from AdcBus)
...
/// Battery readings are obtained from the shared AdcBus.
...
impl<'d> PowerControl<'d> {
    ...
    pub fn new(peripherals: PowerPeripherals) -> Self {
    ...
    pub fn update(&mut self, adc_bus: &mut AdcBus) {
        ...
        log::info!("Battery: {:.2}V ({}%) [raw: {}]", voltage, percentage, raw);
    }
